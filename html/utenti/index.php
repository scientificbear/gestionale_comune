            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Utenti</h4>
                        <div class="d-flex align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb m-0 p-0">
                                    <li class="breadcrumb-item"><a href="../home/index.php" class="text-muted">Home</a></li>
                                    <li class="breadcrumb-item text-muted active" aria-current="page">Utenti</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
                            ...
                            <div class="card-body">
                                ...
                                if($result = $mysqli->query($sql)){
                                    ...
                                    while($row = $result->fetch_array()){
                                        ...
                                        $_SESSION["role"], array("admin", "editor"));
                                        protect_content("<span> - </span><a href='enable.php?id=". $row['id'] ."' title='Cambia circoscrizioni'><i class='fas fa-sitemap'></i></a>",
                                        $_SESSION["role"], array("admin", "editor"));
