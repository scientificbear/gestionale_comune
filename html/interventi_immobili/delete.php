...
if(isset($_POST["id"]) && !empty($_POST["id"])){
    ...
    $sql = "DELETE FROM interventi_immobili WHERE id = ?";
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                ...
                <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Elimina intervento</h4>
                ...
                <div class="col-12">
                        <div class="card">
                            <div class="card-body col-md-6 m-auto">
                                ...
                                <br />
                                <h4 class="card-title">Immobile</h4>
                                <p class="card-text"><?php echo $row["nome_immobile"]; ?></p>
                                <br />
                                <h4 class="card-title">Ditta</h4>
